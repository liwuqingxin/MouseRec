...
namespace Mouser.Utils
{
    public static class JsonUtil
    {
        ...
        public static string SerializeWithTypeNameHandlingByNsj<T>(T t)
        {
            ...
            return JsonConvert.SerializeObject(t, indented, settings);
        }
        ...
        /// </summary>
        /// <returns>json文本</returns>
        public static T DeserializeWithTypeNameHandlingByNsj<T>(string json)
        {
            var settings = new JsonSerializerSettings()
            {
                TypeNameHandling = TypeNameHandling.All
        ...
        /// </summary>
        /// <returns>json文本</returns>
        public static string SerializeByNsj<T>(T t)
        {
        ...
        /// <returns>对象</returns>
        public static T DeserializeByNsj<T>(string jsonStr) where T : class
        {
        ...
        /// <returns>对象</returns>
        public static object DeserializeByNsj(string jsonStr, Type type)
        {
        ...
        /// <returns>对象</returns>
        public static T TryDeserializeByNsj<T>(string jsonStr, EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> errorHandle = null) where T : class
        {
            var settings = new JsonSerializerSettings
            {
                Error = errorHandle,
        ...
        /// <param name="errorHandle">异常处理回调。如果为空，则抛出异常</param>
        /// <returns>对象</returns>
        public static object TryDeserializeByNsj(string jsonStr, Type type, EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> errorHandle = null)
        {
            var settings = new JsonSerializerSettings
            {
                Error = errorHandle,
        ...
        // https://www.cnblogs.com/ouyangqiao/p/5642592.html
